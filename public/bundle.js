...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Greeter, { name: nameVar }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Greeter = React.createClass({
	    ...
	    handleNewName: function handleNewName(newName) {
	        this.setState({
	            name: newName
	        });
	    },
	    handleNewMessage: function handleNewMessage(newMessage) {
	        this.setState({
	            message: newMessage
	        });
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GreeterMessage = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var nameNow = this.props.name;
	        var messageNow = this.props.message;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GreeterForm = React.createClass({
	    ...
	    onSubmit: function onSubmit(e) {
	        ...
	        var newName = this.refs.form_name.value;

	        if (newName.length > 0) {
	            this.refs.form_name.value = '';
	            this.props.onNewName(newName);
	        }

	        var newMessage = this.refs.form_message.value;

	        if (newMessage.length > 0) {
	            this.refs.form_message.value = '';
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement('input', { type: 'text', ref: 'form_name' }),
	            React.createElement('br', null),
	            React.createElement('textarea', { type: 'text', ref: 'form_message' }),
	            React.createElement('br', null),
	            React.createElement(
	                'button',
	                null,
